...
PROTOTYPE(void rice_RebuildRule, (FILE *, OBJ_RULE *));
PROTOTYPE(void rice_RebuildRelation, (FILE *, OBJ_RELATION *));


#define RebuildRule       rice_RebuildRule
#define RebuildRelation   rice_RebuildRelation
