...
/*
   ...
   Info:   header file for RICE with compiler adjustments
*/


#define FUNCTION(f, l1, l2a, l2b)   f l1
/*#define FUNCTION(f, l1, l2a, l2b)   f l2a l2b*/

#define PROTOTYPE(f, l)             f l
/*#define PROTOTYPE(f, l)             f ()*/

#define VARARGS(d, v, a)            v
/*#define VARARGS(d, v, a)            d v a*/

#define VA_START(l, v)              va_start(l, v)
/*#define VA_START(l, v)              va_start(l)*/
