...
/*
   ...
   Info:   UNIX compiler header file for RICE
*/


#define RICE_FUNCTION(func, args, vars, decls)   func vars decls
#define RICE_PROTOTYPE(func, args)               func ()
#define RICE_MERGE(head, tail)                   head##tail
